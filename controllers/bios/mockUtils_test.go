...
func (m *mockCommonRec) GetBiosSchemaObject(ctx context.Context, field, value, ns string) *infraiov1.BiosSchemaRegistry {
	if value == "biosattributeregistryu32v1268" {
		return &infraiov1.BiosSchemaRegistry{Spec: infraiov1.BiosSchemaRegistrySpec{Attributes: []map[string]string{{"someAttribute": "someValue"}}}}
	}
	return nil
}
func (m *mockCommonRec) GetBiosObject(ctx context.Context, field, value, ns string) *infraiov1.BiosSetting {
	if value == "10.10.10.10" {
		return &infraiov1.BiosSetting{}
	}
	return nil
}
...
func (m *mockRestClient) Get(url string, reason string) (map[string]interface{}, int, error) {
	// Test_biosUtils_getBiosLinkAndBody & Test_biosUtils_GetBiosAttributes mock
	if url == "/redfish/v1/Systems/fakeID/Bios" {
		return map[string]interface{}{
			"@Redfish.Settings": map[string]interface{}{
				"SettingsObject": map[string]interface{}{
					"@odata.id": "/redfish/v1/Systems/fakeID/Bios/Settings/",
				},
			},
			"Attributes": map[string]interface{}{"someAttribute": "someValue"},
		}, 200, nil
	}
	// Test_biosUtils_GetBiosAttributeID mock 1
	if url == "/redfish/v1/Registries/" {
		return map[string]interface{}{
			"Members": []interface{}{
				map[string]interface{}{
					"@odata.id": "/redfish/v1/Registries/BiosAttributeRegistryU32.v1_2_68",
				},
			},
		}, 200, nil
	}
	// Test_biosUtils_GetBiosAttributeID mock 2
	if url == "/redfish/v1/Registries/BiosAttributeRegistryU32.v1_2_68" {
		return map[string]interface{}{
			"Location": []interface{}{
				map[string]interface{}{
					"Language": "en",
					"Uri":      "/redfish/v1/Registries/BiosAttributeRegistryU32.v1_2_68.json",
				},
			},
		}, 200, nil
	}
	// Test_biosUtils_GetBiosAttributeID mock 3
	if url == "/redfish/v1/Registries/BiosAttributeRegistryU32.v1_2_68.json" {
		return map[string]interface{}{
